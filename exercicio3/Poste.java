...
public class Poste {
    ...
    public Poste (String nameTeam, String name, double points, double lose, double bumps, double assists, double time) {
        ...
        this.lose = lose;
        this.bumps = bumps;
        this.value = 3* points + 1* assists + 3* bumps - 3*lose;
        this.time = time;
    }
    ...
    public void setValue(int points, int lose, int bumps, int assists) {
        this.value = 3* points + assists + 3* bumps - 3*lose;
    }
